# Skills VBS — instrucciones para Cursor

Este repositorio es el **origen** de las skills de VB Solutions. Si editas una skill (conexión a servers, Hermes, Chatwoot, extras), **actualiza este repo en el mismo cambio**: `git add`, commit y `git push` a `origin/main`.
