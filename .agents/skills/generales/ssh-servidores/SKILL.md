...
description: >-
  ...
  TSHEILA, clientes). En CUALQUIER sesión — local, Codex web o Cloud Agent —
...
**Cloud Agent / Codex web no tiene** `~/.ssh/config` ni las PEM. No ejecutes `ssh vbs-hermes` a pelo ahí. Resuelve host/usuario/puerto desde `hosts.md` y la clave desde 1Password.
...
## Cloud Agent / Codex web (obligatorio)
